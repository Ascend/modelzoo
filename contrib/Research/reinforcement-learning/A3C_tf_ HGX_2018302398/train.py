...
def main():
    ...
    with tf.Session() as sess:
        ...
        global_Net = A3CNet(env, GLOBAL_NET_SCOPE, sess, OPT, ENTROPY_BETA, lstm=LSTM, input_shape=[None, shape[1], shape[2], shape[0]])
        ...
        for item in LOG:
            (name, G_EP, ep_r, Score, frames_local, frames, t, loss) = item
            t = t-T0
