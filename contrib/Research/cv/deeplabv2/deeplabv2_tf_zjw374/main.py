...
def configure():
	...
	flags.DEFINE_string('data_list', '/cache/user-job-dir/Deeplab-v2--ResNet-101--Tensorflow-master/dataset/train.txt', 'training data list filename')
	...
	flags.DEFINE_string('valid_data_list', '/cache/user-job-dir/Deeplab-v2--ResNet-101--Tensorflow-master/dataset/val.txt', 'validation data list filename')
	...
	flags.DEFINE_string('test_data_list', '/cache/user-job-dir/Deeplab-v2--ResNet-101--Tensorflow-master/dataset/val.txt', 'testing/validation data list filename')
	flags.DEFINE_boolean('visual', True, 'whether to save predictions for visualization')

	# data
	flags.DEFINE_string('data_dir', '/cache/user-job-dir/Deeplab-v2--ResNet-101--Tensorflow-master/data', 'data directory')
	...
	# log
	flags.DEFINE_string('modeldir', '/cache/user-job-dir/Deeplab-v2--ResNet-101--Tensorflow-master/model', 'model directory')
	flags.DEFINE_string('logfile', '/cache/user-job-dir/Deeplab-v2--ResNet-101--Tensorflow-master/log/log.txt', 'training log filename')
	flags.DEFINE_string('logdir', '/cache/user-job-dir/Deeplab-v2--ResNet-101--Tensorflow-master/log', 'training log directory')
...
def main():
	...
	while len(sys.argv) > 1:
		sys.argv.pop()
	TMP_DATA_PATH = '/cache/user-job-dir/Deeplab-v2--ResNet-101--Tensorflow-master/data'
	...
	TMP_LOG_PATH = '/cache/log'
	#OBS_LOG_PATH = 'obs://deeplab-zjw/log'
	TMP_MODEL_PATH = '/cache/model'
	#OBS_MODEL_APTH = 'obs://deeplab-zjw/model/'
	if args.option not in ['train', 'test', 'predict']:
		...
		mox.file.copy_parallel(src_url='/cache/user-job-dir/Deeplab-v2--ResNet-101--Tensorflow-master/model', dst_url=args.train_url)
		mox.file.copy_parallel(src_url='/cache/user-job-dir/Deeplab-v2--ResNet-101--Tensorflow-master/log', dst_url=args.train_url)
if __name__ == '__main__':
	#os.environ['SLOG_PRINT_TO_STDOUT'] = "1"
	main()
	# mox.file.copy_parallel(src_url='/model', dst_url=os.path.join(args.train_url, 'model'))
	# mox.file.copy_parallel(src_url='/log', dst_url=os.path.join(args.train_url, 'log'))