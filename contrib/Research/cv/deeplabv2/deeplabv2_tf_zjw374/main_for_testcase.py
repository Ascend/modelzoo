...
def configure():
    ...
    flags.DEFINE_string('pretrain_file', '/cache/pretrained_model/deeplab_resnet.ckpt',
                        'pre-trained model filename corresponding to encoder_name')
    flags.DEFINE_string('data_list', '/cache/user-job-dir/Deeplab-v2--ResNet-101--Tensorflow-master/testcase/train.txt',
                        'training data list filename')

    # validation
    flags.DEFINE_integer('valid_step', 200, 'checkpoint number for validation')
    flags.DEFINE_integer('valid_num_steps', 100, '= number of validation samples')
    flags.DEFINE_string('valid_data_list',
                        '/cache/user-job-dir/Deeplab-v2--ResNet-101--Tensorflow-master/testcase/val.txt',
                        'validation data list filename')
    ...
    flags.DEFINE_string('test_data_list',
                        '/cache/user-job-dir/Deeplab-v2--ResNet-101--Tensorflow-master/testcase/val.txt',
                        'testing/validation data list filename')
    flags.DEFINE_boolean('visual', True, 'whether to save predictions for visualization')

    # data
    flags.DEFINE_string('data_dir', '/cache/user-job-dir/Deeplab-v2--ResNet-101--Tensorflow-master/data',
                        'data directory')
    ...
    # log
    flags.DEFINE_string('modeldir', '/cache/user-job-dir/Deeplab-v2--ResNet-101--Tensorflow-master/model',
                        'model directory')
    flags.DEFINE_string('logfile', '/cache/user-job-dir/Deeplab-v2--ResNet-101--Tensorflow-master/log/log.txt',
                        'training log filename')
    flags.DEFINE_string('logdir', '/cache/user-job-dir/Deeplab-v2--ResNet-101--Tensorflow-master/log',
...
def main():
    ...
    if args.option not in ['train', 'test', 'predict']:
        ...
        mox.file.copy_parallel(src_url='/cache/user-job-dir/Deeplab-v2--ResNet-101--Tensorflow-master/model',
                               dst_url=args.train_url)
        mox.file.copy_parallel(src_url='/cache/user-job-dir/Deeplab-v2--ResNet-101--Tensorflow-master/log',
                               dst_url=args.train_url)
