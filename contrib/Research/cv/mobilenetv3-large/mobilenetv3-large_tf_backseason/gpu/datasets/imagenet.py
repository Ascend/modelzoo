...
def create_readable_names_for_imagenet_labels(dataset_dir):
  ...
  synset_url = '{}/imagenet_lsvrc_2015_synsets.txt'.format(dataset_dir)
  synset_to_human_url = '{}/imagenet_metadata.txt'.format(dataset_dir)
...
def get_split(split_name, dataset_dir, file_pattern=None, reader=None):
  ...
  if LOAD_READABLE_NAMES:
    if dataset_utils.has_labels(dataset_dir):
      ...
      labels_to_names = create_readable_names_for_imagenet_labels(dataset_dir)
