...
ckpt_path = '/opt/npu/models/mobilenetv2_v0.1/ckpt/'
...
def main(_):
  ...
  with tf.Graph().as_default():
    ...
    iterator, _ = data_provider.get_data(dataset, FLAGS.batch_size,
                                         ...
                                         hvd=None, enable_hvd=None, data_loader_mode='united')
    ...
    eval_accuracy, metric_update_op = tf.compat.v1.metrics.accuracy(labels, predictions)

    # tf.compat.v1.summary.scalar('top1_acc', top1_accu)
    ...
    with tf.compat.v1.Session() as sess:
      ...
      #saver.restore(sess, 'results/model.ckpt-187670')
      #saver.restore(sess, '123/model.ckpt-62500')
    #   saver.restore(sess, '242_0624_second/model.ckpt-125200')
      #saver.restore(sess, '123/model.ckp')
      tf.io.write_graph(sess.graph, logdir, 'graph.pbtxt')
