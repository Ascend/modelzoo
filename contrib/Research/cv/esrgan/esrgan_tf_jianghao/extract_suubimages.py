...
def main():
    ...
    # HR images
    opt['input_folder'] = '/media/jianghao/Elements/SR/BasicSR/datasets/DIV2K/DIV2K_train_HR'
    opt['save_folder'] = '/media/jianghao/Elements/SR/BasicSR/datasets/DIV2K/train/HR_sub'
    opt['crop_size'] = 480
    opt['step'] = 240
    opt['thresh_size'] = 0
    ...
    # LRx4 images
    opt['input_folder'] = '/media/jianghao/Elements/SR/BasicSR/datasets/DIV2K/DIV2K_train_LR_bicubic/X4'
    opt['save_folder'] = '/media/jianghao/Elements/SR/BasicSR/datasets/DIV2K/train/HR_sub'
    opt['crop_size'] = 120
    opt['step'] = 60
    opt['thresh_size'] = 0
