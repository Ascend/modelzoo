...
parser.add_argument('--train_filename', default='./data/celeba_hq/train_shuffled.flist', type=str,
                    help='The output filename.')
parser.add_argument('--validation_filename', default='./data/celeba_hq/validation_shuffled.flist', type=str,
                    help='The output filename.')
