...
analysis_profiling 8 >> ${currentDir}/result/${scriptname}.log
...
python3.7 ${currentDir}/../tools/analysis_check_excel_8p.py 100 ${currentDir}/profiling/${scriptname} ${scriptname} ${currentDir}
...
echo "[`date +%Y%m%d-%H:%M:%S`] [INFO] fluctuation: ${fluctuation}" >> ${currentDir}/result/${scriptname}.log
