...
def main(_):
  ...
  # downloading.
    ...
    #        learning_rate_input).minimize(cross_entropy_mean)
      ...
      # Training loop.
      best_accuracy = 0
      training_steps_max = 2 #np.sum(training_steps_list)
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      ...
      default='http://drcd.xausky.cn/api/download?repository=registry.cn-shanghai.aliyuncs.com/hwdataset/hw&digest=sha256:af14739ee7dc311471de98f5f9d2c9191b18aedfe957f4a6ff791c709868ff58',
  ...
  parser.add_argument(
      '--train_dir',
      type=str,
      default='./output/speech_commands_train',
