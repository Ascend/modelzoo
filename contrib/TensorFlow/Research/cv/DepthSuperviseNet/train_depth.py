...
def main(args):
    ...
    log_dir = os.path.join(args.train_url, 'logs', args.protocol, subdir)
    ...
    utils.make_if_not_exist(log_dir)
...
def parse_arguments(argv):
    ...
    parser.add_argument("--train_url", type=str, default='/home/ajliu/LAJ/HUAWEI_v2/Jobs/')
    parser.add_argument("--data_url", type=str, default='/home/ajliu/LAJ/pad_datasets/Oulu-Train/')
    ...
    parser.add_argument("--max_nrof_epochs", type=int, default=50)
