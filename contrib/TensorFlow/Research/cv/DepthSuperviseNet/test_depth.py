...
def parse_arguments(argv):
    ...
    parser.add_argument("--train_url", type=str, default='/home/ajliu/LAJ/HUAWEI_v2/Jobs_tan/')
    parser.add_argument("--data_url", type=str, default='/home/ajliu/LAJ/pad_datasets/Oulu-Test/')
