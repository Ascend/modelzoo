...
_CHECKPOINT_PATHS = {
    'rgb': '/home/jida/i3d/data/checkpoints/rgb_scratch/model.ckpt',
    'flow': '/home/jida/i3d/data/checkpoints/flow_scratch/model.ckpt',
    'rgb_imagenet': '/home/jida/i3d/data/checkpoints/rgb_imagenet_up/model_up.ckpt',
    'flow_imagenet': '/home/jida/i3d/data/checkpoints/flow_imagenet/model.ckpt',
}
...
#         os.path.join('/home/ma-user/work/data', dataset, mode + '.txt'),
#         os.path.join('/home/ma-user/work/data', dataset, 'testlist%02d' % split + '.txt'))
