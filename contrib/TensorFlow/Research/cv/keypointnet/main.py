...
tf.app.flags.DEFINE_string("local_data_path", "/cache/data/",
...
def create_input_fn(split, batch_size):
    ...
    if (not os.path.exists(os.path.join(FLAGS.local_data_path, "test.txt"))
            or not os.path.exists(
                os.path.join(FLAGS.local_data_path, "dev.txt"))):
...
def main(argv):
    ...
    FLAGS.local_data_path = FLAGS.data_url
