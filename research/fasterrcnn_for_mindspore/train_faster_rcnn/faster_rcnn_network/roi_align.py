...
class SingleRoIExtractor(nn.Cell):
    ...
    def set_train_local(self, training=True):
        ...
        self.batch_size = self.train_batch_size*self.batch_size if self.training_local else  cfg.test_batch_size*self.batch_size
        ...
        self.res_ = Tensor(np.array(np.zeros((
