...
from vgg16.datasets import imagenet_dataset_c
...
from vgg16.utils.average_meter import AverageMeter
from vgg16.optimizers import default_wd_filter
...
def parse_args(cloud_args={}):
    ...
    # dataset related
    parser.add_argument('--data_dir', type=str, default='/opt/npu/datasets/imagenet/train', help='train data dir')
...
def train(cloud_args={}):
    ...
    # dataloader
    de_dataset = imagenet_dataset_c(args.data_dir, args.image_size, 
    ...
    mixed_precision_warpper(network, 'O2')
