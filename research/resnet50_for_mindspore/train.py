...
os.system('su root -c "adc --host 127.0.0.1:22118 --log \\"SetLogLevel(0)[{}]\\" --device 1"'.format(loglevel))
os.system('su root -c "adc --host 127.0.0.1:22118 --log \\"SetLogLevel(0)[{}]\\" --device 2"'.format(loglevel))
os.system('su root -c "adc --host 127.0.0.1:22118 --log \\"SetLogLevel(0)[{}]\\" --device 3"'.format(loglevel))
os.system('su root -c "adc --host 127.0.0.1:22118 --log \\"SetLogLevel(0)[{}]\\" --device 4"'.format(loglevel))
os.system('su root -c "adc --host 127.0.0.1:22118 --log \\"SetLogLevel(0)[{}]\\" --device 5"'.format(loglevel))
os.system('su root -c "adc --host 127.0.0.1:22118 --log \\"SetLogLevel(0)[{}]\\" --device 6"'.format(loglevel))
os.system('su root -c "adc --host 127.0.0.1:22118 --log \\"SetLogLevel(0)[{}]\\" --device 7"'.format(loglevel))
...
from resnet50.datasets import imagenet_dataset
...
from resnet50.optimizers import default_wd_filter
...
def parse_args(cloud_args={}):
    parser = argparse.ArgumentParser('mindspore imagenet training')
...
def train(cloud_args={}):
    ...
    # dataloader
    de_dataset = imagenet_dataset(args.data_dir, args.image_size, 
