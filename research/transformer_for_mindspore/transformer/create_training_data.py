...
flags.DEFINE_string("vocab_file", None,
                    "The vocabulary file that the Transformer model was trained on.")
...
def create_training_instance(source_words, target_words, max_seq_length):
  """Creates `TrainingInstance`s for a single sentence pair."""
  EOS = "</s>"
  SOS = "<s>"
  ...
  if len(source_sos_tokens) > max_seq_length or len(target_sos_tokens) > max_seq_length:
    return None
