...
class TransformerTraining(nn.Cell):
    ...
    def construct(self, source_ids, source_mask, target_ids, target_mask):
        encoder_outputs, decoder_outputs, embedding_table = \
...
class TransformerTrainingLoss(nn.Cell):
    ...
    """
    def __init__(self, config):
        super(TransformerTrainingLoss, self).__init__()
...
class TransformerTrainOneStepCell(nn.Cell):
    ...
    Args:
        ...
        parallel_mode (str): There are five kinds of parallel modes, "stand_alone", "data_parallel",
                             "hybrid_parallel", "semi_auto_parallel", "auto_parallel". Default: "stand_alone".
        ...
        model_parallel_filter (list): The name list of parameters which use model parallel. Default: None.
    """
