...
def construct_estimator(model_dir, params):
  ...
  if params["accelerator"] == "1980":
  	...
  	npu_config = NPURunConfig(save_summary_steps=10000, enable_data_pre_proc=True, precision_mode="allow_mix_precision", save_checkpoints_steps=10000, session_config=session_config, model_dir=model_dir, iterations_per_loop=100, keep_checkpoint_max=5, hcom_parallel=True)
