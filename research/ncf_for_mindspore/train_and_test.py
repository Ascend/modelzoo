...
def test_train_eval_callback():
    ...
    eval_callback = EvalCallBack(model, ds_eval, ncf_metric, eval_file_path=os.path.join(args.output_path, args.eval_file_name))
    out = model.eval(ds_eval)
    model.train(epochs, 
                ds_train, 
                callbacks=[eval_callback, callback], 
