...
from src.optimizers import default_wd_filter
from src.network import DenseNet121
from src.datasets import imagenet_dataset
...
from src.utils.mixed_precision import mixed_precision_warpper
from src.utils.cloud_copy_cache import copy_mox_ckpt_log_to_s3
...
def parse_args(cloud_args={}):
    ...
    parser.add_argument('--T_max', type=int, default=120, help='T-max in cosine_annealing scheduler')
    parser.add_argument('--max_epoch', type=int, default=120, help='max epoch num to train the model')
