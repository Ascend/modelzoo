...
# context.set_context(mode=context.GRAPH_MODE, backend_policy="ge",
...
try:
    from mindspore.nn import ParallelMode
except:
...
try:
    import mindspore.dataset.dataengine as de
    import mindspore.dataset.transforms.py_transforms as F
except:
    try:
        import mindspore.dataengine as de
        import mindspore.transforms.py_transforms as F
    except:
...
from mobilenet_v2.utils.average_meter import AverageMeter
from mobilenet_v2.optimizers import default_wd_filter
...
def parse_args(cloud_args={}):
    ...
    # dataset related
    parser.add_argument('--data_dir', type=str, default='/opt/npu/ldy/datasets/imagenet/imagenet/train', help='train data dir')
    parser.add_argument('--eval_data_dir', type=str, default='/opt/npu/datasets/imagenet/val', help='val data dir')
...
def train(cloud_args={}):
    ...
    de_dataset.map_model = 8  # !!!important
