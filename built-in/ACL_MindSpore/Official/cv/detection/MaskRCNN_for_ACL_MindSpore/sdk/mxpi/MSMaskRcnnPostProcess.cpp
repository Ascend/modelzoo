...
APP_ERROR MSMaskRcnnPostProcessor::Init(
...
APP_ERROR MSMaskRcnnPostProcessor::Process(
...
void MSMaskRcnnPostProcessor::GetValidDetBoxes(
    std::vector<std::shared_ptr<void>>& featLayerData,
...
void MSMaskRcnnPostProcessor::ConvertObjInfoFromDetectBox(
    std::vector<MxBase::DetectBox>& detBoxes,
    std::vector<ObjDetectInfo>& objInfos,
    ImageInfo& imgInfo) {
 ...
 * @return: void
 */
void MSMaskRcnnPostProcessor::ObjectDetectionOutput(
    std::vector<std::shared_ptr<void>>& featLayerData,
    std::vector<ObjDetectInfo>& objInfos,
    ImageInfo& imgInfo) {
