...
#include "MxpiMSFasterRcnnPostProcessor.h"
 ...
 */
APP_ERROR MxpiMSFasterRcnnPostProcessor::Init(
    ...
    if (ret != APP_ERR_OK) {
        LogError << GetError(ret) << "Fail to init MxpiMSFasterRcnnPostProcessor.";
        return ret;
    }
    LogInfo << "End to initialize MxpiMSFasterRcnnPostProcessor.";
    return APP_ERR_OK;
}
 ...
 * @return: APP_ERROR error code.
 */
APP_ERROR MxpiMSFasterRcnnPostProcessor::Process(
