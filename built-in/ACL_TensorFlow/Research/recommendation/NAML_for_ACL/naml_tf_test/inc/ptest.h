...
#define _TEST(NAMESPACE, FIXTURECLASS, TESTNAME, CASENAME)                                                                                                          \
    ...
    ptest::TestFixtureRegister g_register_##TESTNAME##_##CASENAME(_STR(TESTNAME##_##CASENAME), &g_fixture_##TESTNAME##_##CASENAME, g_func_##TESTNAME##_##CASENAME); \
    void g_func_##TESTNAME##_##CASENAME(void)

#define TEST(TESTNAME, CASENAME) \
    _TEST(ptest, TestFixture, TESTNAME, CASENAME)

#define TEST_F(TESTFIXTURE, CASENAME) \
    _TEST(_EMPTY_NAMESPACE, TESTFIXTURE, TESTFIXTURE, CASENAME)
