...
def parse_args():
    ...
    parser.add_argument('--batchsize', default=1,
                        help="""batchsize""")
    parser.add_argument('--model_path', default='densenet_tf_910.pb',
                        help="""pb path""")
    parser.add_argument('--image_path', default = '/autotest/wlx/image-50000',
                        help = """the data path""")
    parser.add_argument('--label_file', default='/autotest/xwx5322041/resnet50/01-onlineInfer/val_lable.txt',
                        help="""label file""")
    parser.add_argument('--input_tensor_name', default = 'input:0',
                        help = """input_tensor_name""")
    parser.add_argument('--output_tensor_name', default='linear/BiasAdd:0',
