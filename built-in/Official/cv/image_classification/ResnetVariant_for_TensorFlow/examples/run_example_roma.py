...
if __name__ == '__main__':
    if len(sys.argv) not in [3, 4] and not sys.argv[1].endswith(".yml"):
        print("Usage:")
        print("    python3 ./run_example.py <algorithm's config file> [pytorch(default)]|[p]|[tensorflow]|[t] <zone>")
        print("for example:")
        print("    python3 ./run_example.py ./nas/cars/cars.yml hn1_y")
        print("    python3 ./run_example.py ./nas/cars/cars.yml tensorflow hn1_y")
    # set backend
