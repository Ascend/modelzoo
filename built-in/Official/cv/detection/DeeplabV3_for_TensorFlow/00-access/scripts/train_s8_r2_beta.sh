...
CKPT_NAME=${CURRENT_DIR}/results/s8/r1/0/resnet_101/model.ckpt-15000
PASCAL_DATASET=${CURRENT_DIR}/datasets/pascal_voc_seg/tfrecord
NUM_ITERATIONS=10000
#start exec

python3.7 ${CURRENT_DIR}/train_npu.py --model_variant='resnet_v1_101_beta' \
                                      --train_split='train' \
                                      --atrous_rates=6 \
                                      --atrous_rates=12 \
                                      --atrous_rates=18 \
