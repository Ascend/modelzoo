...
if __name__ == "__main__":
    ...
    if cfg.get_npy:
        ...
        for i in dirname:
            filename = os.listdir("{}/{}".format(cfg.audio_path, i))
            if not os.path.isdir("{}/{}".format(cfg.npy_path, i)):
                os.mkdir("{}/{}".format(cfg.npy_path, i))
            for j in filename:
                compute_melgram("{}/{}/{}".format(cfg.audio_path, i, j),
                                "{}/{}/".format(cfg.npy_path, i), j)
