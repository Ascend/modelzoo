...
```shell
git clone xxx
cd ModelZoo_Vgg16_TF_HARD/ModelZoo_Vgg16_ACL
```
...
- Run the program:
  ...
  ```
  cd scripts
  ./benchmark_tf.sh --batchSize=1 --modelType=vgg16 --imgType=raw --precision=fp16 --outputType=fp32 --useDvpp=1 --deviceId=0 --modelPath=googlenet_tf_aipp.om --dataPath=image-1024 --trueValuePath=val_lable.txt
  ```
