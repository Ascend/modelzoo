...
class CCenterfaceInfer : public CBaseInfer {
   ...
   public:
    CCenterfaceInfer(uint32_t deviceId) : CBaseInfer(deviceId) {}
    virtual void DoPostProcess(std::vector<MxBase::TensorBase>& tensors) {
