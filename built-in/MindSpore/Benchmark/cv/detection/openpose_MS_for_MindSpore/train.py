...
def train():
    ...
    # lr scheduler
    lr_stage,lr_base,lr_vgg =get_lr(params['lr']*args.group_size,params['lr_gamma'],steps_per_epoch,params["max_epoch_train"],args.lr_steps,args.group_size)
    ...
    #train_net = TrainingWrapper(train_net, opt,scale_sense=manager)#, sens=params['loss_scale'])    # basic gradient optimization
    train_net = TrainingWrapper(train_net, opt, sens=args.loss_scale)
