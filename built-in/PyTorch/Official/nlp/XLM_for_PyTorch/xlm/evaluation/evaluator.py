...
class Evaluator(object):
    ...
    def mask_out(self, x, lengths, rng):
        ...
        _x_real = x[pred_mask]
        x_zero = (x * pred_mask).view(-1)
        x_real_len = _x_real.shape[0]
        ...
        return x, x_zero, pred_mask, x_real_len
    ...
    def evaluate_mlm(self, scores, data_set, lang1, lang2):
        ...
        for batch in self.get_iterator(data_set, lang1, lang2, stream=(lang2 is None)):
            ...
            x, y, pred_mask, y_real_len = self.mask_out(x, lengths, rng)
