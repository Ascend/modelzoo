...
from data import tokenizer, Dictionary
...
def main(args):
    ...
    use_npu = 'npu' in args.CALCULATE_DEVICE
    ...
    def process_batch(batch):
        ...
        if use_npu:
            tokens = tokens.to(args.CALCULATE_DEVICE)
            lengths = lengths.to(args.CALCULATE_DEVICE)
