...
class ParallelTfrecordInputPipelineConcat(InputPipeline):
  ...
  def _decode_record(self, record, name_to_features):
    ...
    del example["target_eos_segids"]
    del example["target_eos_posids"]
  ...
  def read_data(self, seed=None, **kwargs):
    ...
    # extra ids
    features["source_segids"] = inputs["source_eos_segids"]
    features["source_posids"] = inputs["source_eos_posids"]
    features["target_segids"] = inputs["target_sos_segids"]
    features["target_posids"] = inputs["target_sos_posids"]
