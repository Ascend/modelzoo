...
def _create_from_dict(dict_, *args, **kwargs):
  ...
  """
  if not "class" in dict_:
    raise ValueError("Input Pipeline definition must have a type property.")

  class_ = registry.class_ins(dict_["class"])
  # Constructor arguments
  params = {}
  if "params" in dict_:
    params.update(dict_["params"])
