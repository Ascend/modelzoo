...
#### Train on NPU
## prepare
1) change BERT_BASE_DIR and SQUAD_DIR to the real path in scripts/run_*.sh
2) set env in scripts/run_*.sh
...
predit for 8P:
cd ../
python3 evaluate-v1.1.py dataset/dev-v1.1.json .scripts/result/8p/0/output/predictions.json
