...
def convert_single_example(ex_index, example, label_list, max_seq_length,
  ...
  #print("convert_single_example label_list", label_list)
  label_map = {}
  ...
  #print("===========")
  #print(tokens_a)
  #print("type:tokens_a", type(tokens_a), "tokens_a len", len(tokens_a))
  tokens_b = None
  if example.text_b:
    #tokens_b = tokenizer.tokenize(example.text_b)
    tokens_b = fulltokenize(example.text_b,vocab)
    #print("type:tokens_b", type(tokens_b), "tokens_b len", len(tokens_b))
  if tokens_b:
  ...
  tokens.append("[SEP]")
  segment_ids.append(0)
  #print("Before tokens_b segment_ids", segment_ids)
  if tokens_b:
  ...
  #print("==========convert_single_example===========")
  #print(tokens)
  #print(input_ids)
  #print("After tokens_b input_ids", input_ids)
