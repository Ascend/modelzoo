...
from official.nlp.transformer import npu_ops
  ...
  def encode(self, inputs, attention_bias, training):
    ...
    with tf.name_scope("encode"):
      ...
      if training:
        ...
        encoder_inputs = npu_ops.dropout(
            encoder_inputs, keep_prob= 1 - self.params["layer_postprocess_dropout"])
  ...
  def decode(self, targets, encoder_outputs, attention_bias, training):
    ...
    with tf.name_scope("decode"):
      ...
      if training:
        ...
        decoder_inputs = npu_ops.dropout(
...
class PrePostProcessingWrapper(tf.keras.layers.Layer):
  ...
  def call(self, x, *args, **kwargs):
    ...
    if training:
      ...
      y = npu_ops.dropout(y, keep_prob=1-self.postprocess_dropout)
    return x + y
