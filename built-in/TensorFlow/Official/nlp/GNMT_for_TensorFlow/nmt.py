...
def add_arguments(parser):
  ...
  # NPU config
  parser.add_argument(
      "--use_npu", type=bool, default=True, help="whether to use NPU.")
  parser.add_argument(
      "--cast_output_layer", type=bool, default=True, help="whether to cast the last layer output_projection and beam search to fp16.")
  parser.add_argument(
      "--data_shuffle", type=bool, default=False, help="whether to shuffle data.")
  parser.add_argument(
      "--use_npu_distribution", type=bool, default=False, help="whether to use npu_distribution(8p).")
...
def main(unused_argv):
  ...
  os.environ["use_npu"] = str(FLAGS.use_npu).lower()
  os.environ["cast_output_layer"] = str(FLAGS.cast_output_layer).lower()
  os.environ["data_shuffle"] = str(FLAGS.data_shuffle).lower()
  os.environ["use_npu_distribution"] = str(FLAGS.use_npu_distribution).lower()
