...
class GraphModule(object):
  ...
  def __init__(self, name):
    ...
    self.__variable_scope = tf.variable_scope(name, reuse=tf.AUTO_REUSE)
  ...
  def variable_scope(self):
    ...
    return self.__variable_scope

  def varaible_created(self):
    return self._template._variables_created
