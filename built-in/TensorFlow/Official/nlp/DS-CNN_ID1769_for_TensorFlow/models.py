...
def prepare_model_settings(label_count, sample_rate, clip_duration_ms,
  ...
  print('==== desired_samples: {} window_size_samples: {} window_stride_samples: {} spectrogram_length: {}'.format(desired_samples, window_size_samples, window_stride_samples, spectrogram_length) )
  print('==== dct_coefficient_count: {} fingerprint_size: {} label_count: {} sample_rate: {}'.format(dct_coefficient_count, fingerprint_size, label_count, sample_rate) )
