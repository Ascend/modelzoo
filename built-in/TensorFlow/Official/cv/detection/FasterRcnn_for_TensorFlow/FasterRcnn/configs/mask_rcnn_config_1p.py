...
MASK_RCNN_CFG = {
    ...
    'total_steps': 90000, #360000, #22500,
    'training_file_pattern': '/home/c00314821/fast-rcnn/data_new/coco_official_2017/tfrecord/train2017*',
    # ['resnet18', 'resnet34', 'resnet50', 'resnet101', 'resnet152',
    # 'resnet200'] for resnet backbone.
    # ['mnasnet-a1', 'mnasnet-b1', 'mnasnet-small'] for mnasnet backbone.
    'backbone': 'resnet50',
    'checkpoint': '/home/c00314821/fast-rcnn/tf_pretrained/tpu/resnet-50-imagenet/model.ckpt',
    ...
    'eval_samples': 5000,
    'validation_file_pattern': '/home/c00314821/fast-rcnn/data_new/coco_official_2017/tfrecord/val2017*',
    'val_json_file': '/home/c00314821/fast-rcnn/data_new/coco_official_2017/annotations/instances_val2017.json',
