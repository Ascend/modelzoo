...
export RANK_TABLE_FILE=/autotest/shaobin/npu/npu_config/8p.json
...
do
echo
su HwHiAiUser -c "/usr/local/Ascend/toolkit/bin/adc --host 127.0.0.1:22118 --log \"SetLogLevel(0)[info]\" --device "$RANK_ID
