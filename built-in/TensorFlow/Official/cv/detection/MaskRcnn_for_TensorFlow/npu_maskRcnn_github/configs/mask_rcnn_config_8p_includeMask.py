...
MASK_RCNN_CFG = {
    ...
    'training_file_pattern': '/autotest/shaobin/npu_data/data_reMake_includeMask/train*',
    ...
    'eval_samples': 5000,
    'validation_file_pattern': '/autotest/shaobin/npu_data/data_reMake_includeMask/val*',
    'val_json_file': '/autotest/shaobin/npu_data/data_reMake_includeMask/instances_val2017.json',
