...
MASK_RCNN_CFG = {
    ...
    'resize_method': 'retinanet', #'retinanet',  # or 'faster_rcnn'
    ...
    'training_file_pattern': '/npu/traindata/data_reMake_includeMask/train*',
    # ['resnet18', 'resnet34', 'resnet50', 'resnet101', 'resnet152',
    # 'resnet200'] for resnet backbone.
    # ['mnasnet-a1', 'mnasnet-b1', 'mnasnet-small'] for mnasnet backbone.
    'backbone': 'resnet50',
    'checkpoint': '/npu/traindata/data_reMake_includeMask/resnet-50-imagenet/model.ckpt',
    ...
    'eval_samples': 5000,
    'validation_file_pattern': '/npu/traindata/data_reMake_includeMask/val*',
    'val_json_file': '/npu/traindata/data_reMake_includeMask/instances_val2017.json',
