...
APP_ERROR Yolov3DetectionOpencv::ReadImage(const std::string &imgPath, cv::Mat &imageMat)
{
...
APP_ERROR Yolov3DetectionOpencv::Resize(cv::Mat &srcImageMat, cv::Mat &dstImageMat)
{
