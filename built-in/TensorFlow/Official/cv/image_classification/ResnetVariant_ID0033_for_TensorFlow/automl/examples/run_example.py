...
if __name__ == '__main__':
    ...
    cfg_file = sys.argv[1]
    """
    print("RANK_SIZE==========>",os.getenv('RANK_SIZE'))
    rank_size = int(os.getenv('RANK_SIZE'))
    if rank_size == 1:
        cfg_file = "./automl/examples/nas/backbone_nas/backbone_nas_tf.yml"
    else:
        cfg_file = "./automl/examples/nas/backbone_nas/backbone_nas_tf_8p.yml"
