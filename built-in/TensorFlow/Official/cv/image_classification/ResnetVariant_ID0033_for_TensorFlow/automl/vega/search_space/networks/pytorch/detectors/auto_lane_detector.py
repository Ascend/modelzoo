...
from vega.search_space.networks.network_factory import NetworkFactory, NetTypesMap
from vega.datasets.pytorch.common.auto_lane_pointlane_codec import PointLaneCodec
from vega.datasets.pytorch.common.auto_lane_codec_utils import nms_with_pos, order_lane_x_axis
from vega.datasets.pytorch.common.auto_lane_codec_utils import convert_lane_to_dict
...
class AutoLaneDetector(Network):
    """Faster RCNN."""
    ...
    def __init__(self, desc):
        ...
        def build_module(net_type_name):
            return NetworkFactory.get_network(NetTypesMap[net_type_name], desc[net_type_name].name)(desc[net_type_name])
