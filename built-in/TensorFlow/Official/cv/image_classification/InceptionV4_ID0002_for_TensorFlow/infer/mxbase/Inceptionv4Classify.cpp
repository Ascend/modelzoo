...
APP_ERROR Inceptionv4ClassifyOpencv::Init(const InitParam &initParam)
{
...
APP_ERROR Inceptionv4ClassifyOpencv::DeInit()
{
    dvppWrapper_->DeInit();
    model_->DeInit();
    post_->DeInit();
...
APP_ERROR Inceptionv4ClassifyOpencv::ReadImage(const std::string &imgPath, cv::Mat &imageMat)
{
...
APP_ERROR Inceptionv4ClassifyOpencv::CenterCropImage(cv::Mat &img, cv::Mat &cropImg)
{
...
APP_ERROR Inceptionv4ClassifyOpencv::Resize(const cv::Mat &srcImageMat, cv::Mat &dstImageMat)
{
...
APP_ERROR Inceptionv4ClassifyOpencv::CVMatToTensorBase(const cv::Mat &imageMat, MxBase::TensorBase &tensorBase)
{
...
APP_ERROR Inceptionv4ClassifyOpencv::Inference(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR Inceptionv4ClassifyOpencv::PostProcess(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR Inceptionv4ClassifyOpencv::SaveInferResult(const std::string &imgPath,
...
APP_ERROR Inceptionv4ClassifyOpencv::Process(const std::string &imgPath)
{
    cv::Mat imageMat;
