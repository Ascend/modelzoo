...
def parse_args():
    ...
    parser.add_argument('--batchsize', default=1,
                        help="""batchsize""")
    parser.add_argument('--model_path', default='efficientnet-b0_tf.pb',
                        help="""pb path""")
    ...
    parser.add_argument('--output_tensor_name', default='logits:0',
...
def image_process(image_path, label_file):
    ...
    for file in os.listdir(image_path):
        with tf.Session().as_default():
            ...
            img = _decode_and_center_crop(image, 224)
