...
if [[ $1 == --help || $1 == -h ]];then
    echo"usage:./train_full_16P_256bs_LARS_171.sh <args>"
...
export RANK_SIZE=16
export RANK_TABLE_FILE=${cur_path}/../rank_table_16p.json
...
do
    ...
    nohup taskset -c $a-$c python3 resnet_ctl_imagenet_main.py \
        ...
        --model_dir=${BASE}/output/ckpt_bs256_LARS_16P_$i \
        --distribution_strategy=off \
        --use_tf_while_loop=true \
        --use_tf_function=true \
        --enable_checkpoint_and_export \
        --steps_per_loop=${loop_size} \
...
train_accuracy=`grep train_accuracy $cur_path/output/0/train_0.log|awk 'END {print $8}'|cut -c 1-5`
