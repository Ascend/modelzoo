...
if [[ $1 == --help || $1 == -h ]];then
    echo"usage:./train_full_8P_312bs_LARS.sh <args>"
...
train_accuracy=`grep eval_accuracy $cur_path/output/${ASCEND_DEVICE_ID}/train_${ASCEND_DEVICE_ID}.log|grep -v I|awk 'END {print $5}'| sed 's/,//g' |cut -c 1-5`
