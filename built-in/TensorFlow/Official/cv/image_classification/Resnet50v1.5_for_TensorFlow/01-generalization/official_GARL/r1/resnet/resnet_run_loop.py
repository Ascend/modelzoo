...
def resnet_main(
 ...
 # profiling_config = ProfilingConfig(enable_profiling=True, enable_options = ['task_trace','training_trace'])
  ...
  run_config = NPURunConfig(
        ...
        auto_tune_mode='GA,RL' if flags_obj.Auto_Tune_Mode is True else None,
      #  auto_tune_mode='GA,RL' if flags_obj.Auto_Tune_Mode == 'all' else auto_tune_mode='GA' if flags_obj.Auto_Tune_Mode == 'GA' else flags_obj.Auto_Tune_Mode == 'RL' if flags_obj.Auto_Tune_Mode == 'RL' else auto_tune_mode=None,
...
def define_resnet_flags(resnet_size_choices=None, dynamic_loss_scale=False,
  ...
  flags.DEFINE_float(
      ...
      ##########################################
  flags.DEFINE_bool(
          name='Auto_Tune_Mode',default=False,
          help=flags_core.help_wrap(''))
#  flags.DEFINE_string(
