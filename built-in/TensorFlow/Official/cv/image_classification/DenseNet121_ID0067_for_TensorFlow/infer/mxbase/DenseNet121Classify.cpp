...
APP_ERROR DenseNet121Classify::ReadImage(const std::string &imgPath, cv::Mat &imgMat)
{
...
APP_ERROR DenseNet121Classify::Resize(const cv::Mat &srcMat, cv::Mat &dstMat)
{
...
APP_ERROR DenseNet121Classify::CvMatToTensorBase(const cv::Mat &imgMat, MxBase::TensorBase &tensorBase)
{
...
APP_ERROR DenseNet121Classify::Crop(const cv::Mat &srcMat, cv::Mat &dstMat)
{
...
std::string DenseNet121Classify::FormatResultFile(const std::string &imgPath)
{
...
APP_ERROR DenseNet121Classify::SaveResult(const std::string &imgPath, const std::vector<std::vector<MxBase::ClassInfo>> &batchClsInfos)
{
