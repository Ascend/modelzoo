...
class Model(object):
    ...
    def get_estimator_model_func(self, features, labels, mode, params=None):
        ...
        top_layer, end_points = densenet161(inputs, self.args.num_classes, is_training = is_training)
        ...
        if self.args.restore_path:
            print("num_classes: {}, restore_path: {}".format(self.args.num_classes, self.args.restore_path))
