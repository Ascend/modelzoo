...
1. 数据集下载路径（http://host.robots.ox.ac.uk/pascal/VOC/voc2007/VOCtrainval_06-Nov-2007.tar）
...
- 开始训练。
    ...
    2. 单卡训练
        ...
        2.1 设置单卡训练参数（脚本位于ResNext50_ID0362_TF2_for_TensorFlow\test/train_performance_1p.sh），示例如下。
        ...
        2.2 单卡训练指令（脚本位于ResNext50_ID0362_TF2_for_TensorFlow\test/train_performance_1p.sh） 
