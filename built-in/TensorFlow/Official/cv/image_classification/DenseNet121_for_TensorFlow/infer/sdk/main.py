...
def scan_img_files(file_path):
    """
    scan all image files under file_path
    :param file_path: the dir of image files
    """
...
def write_infer_res(result_dir, img_name, infer_result_str):
    """
    write results of inferences to file
    :param result_dir: result dir to write
    :param img_name: file name of image
    :param infer_result_str: result of inference
    """
...
if __name__ == '__main__':
    ...
    pipeline_file = "../pipeline/densenet121_tf.pipeline"
