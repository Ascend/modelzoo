...
APP_ERROR Resnext50ClassifyOpencv::Init(const InitParam &initParam)
{
...
APP_ERROR Resnext50ClassifyOpencv::DeInit()
{
    dvppWrapper_->DeInit();
    model_->DeInit();
    post_->DeInit();
...
APP_ERROR Resnext50ClassifyOpencv::ReadImage(const std::string &imgPath, cv::Mat &imageMat)
{
...
APP_ERROR Resnext50ClassifyOpencv::CenterCropImage(cv::Mat &img, cv::Mat &cropImg)
{
...
APP_ERROR Resnext50ClassifyOpencv::Resize(const cv::Mat &srcImageMat, cv::Mat &dstImageMat)
{
...
APP_ERROR Resnext50ClassifyOpencv::CVMatToTensorBase(const cv::Mat &imageMat, MxBase::TensorBase &tensorBase)
{
...
APP_ERROR Resnext50ClassifyOpencv::Inference(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR Resnext50ClassifyOpencv::PostProcess(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR Resnext50ClassifyOpencv::Process(const std::string &imgPath)
{
    cv::Mat imageMat;
