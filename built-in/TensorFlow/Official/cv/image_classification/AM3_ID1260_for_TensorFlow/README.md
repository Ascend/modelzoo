...
**描述（Description）：基于TensorFlow框架的自适应跨模态小样本学习网络 (AW3)**
...
- 开始训练。
    ...
    2. 单卡训练
        ...
        2.1 设置单卡训练参数（脚本位于AM3_ID1260_for_TensorFlow/scripts/train_alexnet_1p.sh），示例如下。请确保下面例子中的“--data_dir”修改为用户生成的tfrecord的路径。
