...
def get_model_gradient_multipliers(last_layers, last_layer_gradient_multiplier,bias_multiplier=2.0):
  ...
  for var in tf.model_variables():
    ...
    if 'biases' in var.op.name:
      gradient_multipliers[var.op.name] = bias_multiplier

    # Use larger learning rate for last layer variables.
    for layer in last_layers:
      if layer in var.op.name and 'biases' in var.op.name:
        gradient_multipliers[var.op.name] = bias_multiplier * last_layer_gradient_multiplier
        break
