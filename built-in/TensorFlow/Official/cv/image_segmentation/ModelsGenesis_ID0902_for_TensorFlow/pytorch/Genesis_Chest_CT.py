...
if conf.optimizer == "sgd":
	optimizer = npu_keras_optimizer(torch.optim.SGD(model.parameters(), conf.lr, momentum=0.9, weight_decay=0.0, nesterov=False))
elif conf.optimizer == "adam":
	optimizer = npu_keras_optimizer(torch.optim.Adam(model.parameters(), conf.lr))
else:
	raise
