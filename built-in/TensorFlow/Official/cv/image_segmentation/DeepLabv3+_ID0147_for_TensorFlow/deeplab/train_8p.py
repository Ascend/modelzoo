...
flags.DEFINE_integer('train_batch_size', 7,
...
flags.DEFINE_float('slow_start_learning_rate', 2e-4,
  ...
  with tf.Graph().as_default() as graph:
    ...
    with tf.device(config.optimizer_device()):
      ...
      if FLAGS.optimizer == 'momentum':
        ...
        #add npu tributedop and loss scale
    ...
    #custom_op.parameter_map["dump_path"].s = tf.compat.as_bytes("/root/ascend/log/plog")
    ...
    sess.run(bcast_op)
    session_config.graph_options.rewrite_options.optimizers.extend(["pruning",
                                                            "function",
                                                            "constfold",
                                                            "shape",
                                                            "arithmetic",
    ...
    with contrib_tfprof.ProfileContext(
      ...
      slim.learning.train(
          ...
          saver=tf.train.Saver(max_to_keep=99999))
