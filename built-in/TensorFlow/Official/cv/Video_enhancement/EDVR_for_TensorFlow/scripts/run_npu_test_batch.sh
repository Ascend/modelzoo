...
#profiling
export PROFILING_DIR=/var/log/npu/profiling/
export PROFILING_MODE=false  # true if need profiling
export PROFILING_OPTIONS=training_trace:task_trace
export AICPU_PROFILING_MODE=false  # true if need profiling
export FP_POINT=uniformneighborsampler_1/embedding_lookup
export BP_POINT=Adam/update_dense_1_vars/weights/ApplyAdam
...
for step in $(seq 310000 5000 600000)
do
