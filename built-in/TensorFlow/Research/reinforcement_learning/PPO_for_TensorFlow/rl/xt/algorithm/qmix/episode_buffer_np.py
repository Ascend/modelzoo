...
# limitations under the License.
# ============================================================================
"""episode buffer for qmix algorithm.
follows codes are mainly referenced and copied from:
...
class EpisodeBatchNP:
    """episode batch implemented with numpy."""
    ...
    def _parse_slices(items):
        ...
        if isinstance(items, slice) or \
                isinstance(items, int) or \
                (isinstance(items, (list, np.ndarray))):
