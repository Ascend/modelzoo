...
class Mcts(object):
    ...
    def select_action(self, mode='softmax'):
        ...
        # value_sum = [child.value_sum for child in node.children.values()]
        # for i in range(len(value_sum)):
        #     if value_sum[i] == 0:
        #         value_sum[i] = -21
        # print("visit_counts", visit_counts, value_sum)
