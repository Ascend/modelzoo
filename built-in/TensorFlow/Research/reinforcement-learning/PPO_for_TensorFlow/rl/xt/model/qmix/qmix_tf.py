...
class QMixModel(object):
    ...
    def _gather4d_on_dim3(inputs, indices):
        ...
        logging.debug("len_0d-{}, len_1d-{}, len_2d-{}, len_3d-{}".format(
        ...
        idx_matrix = tf.tile(tf.expand_dims(
            tf.range(0, len_3d, dtype=indices.dtype), 0), [calc_0d, 1])
    ...
    def build_train_graph(self):
        ...
        with self.graph.as_default():
            ...
            chosen_action_qvals = self._gather4d_on_dim3(mac_out[:, :-1],
                                                         self.ph_actions)
            ...
            if self.use_double_q:
                ...
                target_max_qvals = self._gather4d_on_dim3(target_mac_out,
                                                          cur_max_actions)
            else:
