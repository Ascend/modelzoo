...
export RANK_ID=0
export RANK_SIZE=8
export RANK_TABLE_FILE=../scripts/8p.json
...
python3.7 BigGAN/main.py --phase train --dataset train --epoch 10000 --iteration 100 --batch_size 64 --g_lr 0.0002 --d_lr 0.0002 --img_size 128
