...
python3 ${EXEC_DIR}/BigGAN/main.py --phase train --dataset /home/models/ModelZoo_BigGAN_TF_new/dataset/train --epoch 10000 --iteration 100 --batch_size 64 --g_lr 0.0002 --d_lr 0.0002 --img_size 128 > ./train_${device_id}.log 2>&1
