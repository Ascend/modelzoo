...
class Trainer():
    ...
    def __init__(self, data_path, netcfg):
        ...
        self.model_path = '/autotest/CI_daily/CarPeting_HRNet/code/models'
        #self.model_path = './models'
        self.log_path = '/autotest/CI_daily/CarPeting_HRNet/code/logs'
        #self.log_path = './logs'
    ...
    def build_graph(self, is_train):
        with tf.Graph().as_default():
            ...
            custom_op.parameter_map["use_off_line"].b = True # 必须显示开启，在昇腾AI处理器执行训�?            
