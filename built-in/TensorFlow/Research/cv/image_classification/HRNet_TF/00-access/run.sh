...
#tfplugin 包依赖
export PYTHONPATH=/usr/local/Ascend/tfplugin/python/site-packages:$PYTHONPATH:/home/models/tf-hrnet-master
# opp包依赖
...
#python3 top/train.py --net_cfg cfgs/w30_s4.cfg
python3 top/train.py
