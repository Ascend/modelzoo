...
'''
dump_config = {}
dump_config["enable_dump"] = "False"
dump_config["dump_path"] = "/home/bytedance/image_classification"
dump_config["dump_step"] = "0|5|10"
dump_config["dump_mode"] = "all"
dump_config["enable_dump_debug"] = "True"

npu_config = {}
# npu_config["ge.exec.dumpMode"] = "1"
npu_config["ge.exec.enableDumpDebug"] = json.dumps(dump_config)
#npu_config["ge.exec.profilingOptions"] = json.dumps(profiling_config)

npu_device.open(global_options=npu_config).as_default()
'''

npu_config = {}
npu_device.open(device_index=0,global_options=npu_config).as_default()
