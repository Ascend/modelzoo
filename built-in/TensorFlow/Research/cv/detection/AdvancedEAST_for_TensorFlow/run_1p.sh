...
export LD_LIBRARY_PATH=/usr/local/lib/:/usr/lib/:/usr/local/Ascend/fwkacllib/lib64/:/usr/local/Ascend/driver/lib64/common/:/usr/local/Ascend/driver/lib64/driver/:/usr/local/Ascend/add-ons/:/usr/lib/x86_64-linux-gnu:/usr/local/python3.7/lib/:/usr/local/hdf/hdf5/lib/
PATH=$PATH:$HOME/bin
...
export RANK_TABLE_FILE=./npu_config/1p.json
ulimit -c unlimited
