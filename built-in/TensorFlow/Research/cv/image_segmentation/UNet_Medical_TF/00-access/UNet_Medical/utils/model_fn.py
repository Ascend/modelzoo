...
def unet_fn(features, labels, mode, params):
    ...
    with tf.device(device):
        ...
        print("=========model fn ===NPUEstimatorSpec=============")
        ...
        print_op = tf.print(eval_metric_ops)
        ...
        if mode == tf.estimator.ModeKeys.EVAL:
            ...
            ############## npu modify begin #############
            return NPUEstimatorSpec(mode=mode, loss=dice_loss, eval_metric_ops=eval_metric_ops)
            ############## npu modify end #############
    ...
    #return tf.estimator.EstimatorSpec(mode, loss=total_loss, train_op=train_op, eval_metric_ops={})
    ############## npu modify begin #############
    return NPUEstimatorSpec(mode, loss=total_loss, train_op=train_op, eval_metric_ops={})
    ############## npu modify end #############
