...
cd ${work_dir}
python3 ${upDir}/main_npu.py --data_dir=${data_dir} --model_dir=result --exec_mode=train --npu_loss_scale=1048576 --max_steps=80 --benchmark --fold=${fold} --batch_size=2 --augment   > ${fold_dir}/fold-${fold}_Device-${ASCEND_DEVICE_ID}.log 2>&1
