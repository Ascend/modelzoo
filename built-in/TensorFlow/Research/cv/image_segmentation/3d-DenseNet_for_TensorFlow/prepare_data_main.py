...
FLAGS.DEFINE_string('data_dir',
                    '/home/out/3d-DenseNet_npu/video',
                    'Path to the input data')
FLAGS.DEFINE_string('train_output_path',
                    '/home/out/3d-DenseNet_npu/train.tfrecord',
                    'Path to output train TFRecord')
FLAGS.DEFINE_string('eval_output_path',
                    '/home/out/3d-DenseNet_npu/eval.tfrecord',
...
def process_dataset(train_writer, eval_writer, data_dir):
    ...
    for class_dir in os.listdir(data_dir):
        ...
        if os.path.isdir(class_path):
            ...
            print("======", int(FLAGS.train_eval_split_factor * len(video_filenames)), len(video_filenames))
