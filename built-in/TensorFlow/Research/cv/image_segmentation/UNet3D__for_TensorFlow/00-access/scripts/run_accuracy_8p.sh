...
then
    ...
    do
        ...
        do
            RANK_ID=${device_index} ASCEND_DEVICE_ID=${device_index} ${currentDir}/train_accuracy_8p.sh ${data_dir} ${i} &
        done
    ...
    python3.7 ${upDir}/runtime/parse_results.py --model_dir ${out_dir} --env accuracy
else
