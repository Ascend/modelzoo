...
then
    ...
    do
        ...
        do
            RANK_ID=${device_index} ASCEND_DEVICE_ID=${device_index} ${currentDir}/exec_8p.sh ${i} &
        done
    ...
    for device_index in ${device_group}
    do
        RANK_ID=${device_index} ASCEND_DEVICE_ID=${device_index} ${currentDir}/exec_8p.sh ${fold} &
    done
