...
def parse_flags(flags_obj):
  ...
  return {
      ...
      "debug_mod": flags_obj.debug_mod,
      "debug_steps": flags_obj.debug_steps,
      "print_freq": flags_obj.print_freq,
      "accelerator": flags_obj.accelerator,
      "gpu_num": flags_obj.gpu_num,
...
def define_ncf_flags():
  ...
  flags.DEFINE_integer(
      name="gpu_num", default=1, help=flags_core.help_wrap(
          "number of used gpu."))
	
  flags.DEFINE_enum(
      name="accelerator", default="1980",
      enum_values=["1980", "gpu"], case_sensitive=False,
      help=flags_core.help_wrap("1980 or gpu."))
  ...
  flags.DEFINE_integer(
      name="iterations_per_loop", default=10, help=flags_core.help_wrap(
          "iterations_per_loop."))
  ...
  #################################
  flags.DEFINE_integer(
      name="debug_steps", default=100,
      help=flags_core.help_wrap("Steps for debug."))
  flags.DEFINE_bool(
      name="debug_mod",
      default=False,
      help=flags_core.help_wrap(
          "if True, only run several steps of training."))
  flags.DEFINE_integer(
      name="print_freq", default=100,
      help=flags_core.help_wrap("Steps for debug."))
