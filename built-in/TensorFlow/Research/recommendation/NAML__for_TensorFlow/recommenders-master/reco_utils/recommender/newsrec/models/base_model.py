...
class BaseModel:
    ...
    def __init__(
        ...
        sess_config.graph_options.rewrite_options.optimizers.extend(["GradFusionOptimizer"])
        ...
        #self.train_optimizer = NPUOptimizer(self.train_optimizer, loss_scale_manager, is_loss_scale=True)
