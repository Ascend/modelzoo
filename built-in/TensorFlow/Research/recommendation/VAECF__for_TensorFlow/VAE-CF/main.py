...
def main():
    ...
    if args.batch_size_train % rank_size != 0:
        raise ValueError('Global batch size should be a multiple of the number of workers')

    args.local_batch_size = args.batch_size_train // rank_size
    ...
    vae = VAE(train_data, encoder_dims, total_anneal_steps=args.total_anneal_steps,
              ...
              top_results=args.top_results, rank_size=rank_size, rank_id=rank_id)
