...
rm -rf output/*
python3 run_acc.py -do_predict -data_dir NERdata -vocab_file model/vocab.txt -bert_config model/bert_config.json -init_checkpoint model/bert_model.ckpt -output_dir output -batch_size 32 -learning_rate 2e-5 -num_train_epochs 1
