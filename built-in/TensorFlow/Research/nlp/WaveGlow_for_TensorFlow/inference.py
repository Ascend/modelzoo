...
def get_arguments():
    ...
    parser.add_argument('--lc', type=str, default=None, required=True, help='local condition file')
    ...
    parser.add_argument('--sigma', type=float, default=0.6, help='sigma value for inference')
