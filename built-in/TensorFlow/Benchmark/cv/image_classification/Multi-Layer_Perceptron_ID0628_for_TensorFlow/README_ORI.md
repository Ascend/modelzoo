...
- 开始训练。
    ...
    2. 单卡训练
        ...
        2.1 设置单卡训练参数（脚本位于Multi-Layer_Perceptron_ID0628_for_TensorFlow/test/train_performance_1p.sh），示例如下。
        ...
        2.2 单卡训练指令（脚本位于Multi-Layer_Perceptron_ID0628_for_TensorFlow/test/train_performance_1p.sh） 
