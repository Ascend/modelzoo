...
if __name__ == '__main__':
    ...
    parser.add_argument('dataset_file', default=None, help='Official dataset file')
    parser.add_argument('prediction_folder', default=None,help='prediction folder')
    parser.add_argument('output_metrics', default=None,help='output_metrics')
    args = parser.parse_args()
    files = os.listdir(args.prediction_folder)
    cnt = 0
    file_path = []
    for file in files:
        file_path.append(os.path.join(args.prediction_folder,file))
    for file in file_path:
        ground_truth_file   = json.load(open(args.dataset_file, 'rb'))
        prediction_file     = json.load(open(file, 'rb'))
        ...
        output_file = args.prediction_folder + str(cnt)+args.output_metrics
        cnt = cnt+1
