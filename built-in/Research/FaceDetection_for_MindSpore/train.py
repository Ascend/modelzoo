...
import mindspore.dataset.vision.py_transforms as mindspore_F
import mindspore.dataset.vision.c_transforms as minddata_C
...
def train():
    ...
    for data in ds.create_tuple_iterator(output_numpy=True):
        ...
        loss0, overflow, scaling_sens_r = train_net(img_tensor, coord_mask_tensor_0, conf_pos_mask_tensor_0,
