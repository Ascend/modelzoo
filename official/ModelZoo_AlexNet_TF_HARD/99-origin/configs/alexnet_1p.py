...
config = {
    ...
    #======== model architecture ==========
    'alexnet_version': 'xavier',
    'arch_type': 'original',                                 

    #=======  logger config ======= 
    'display_every': 10,
    'log_name': 'alexnet_8p_he_custom_hxb.log',
    'log_dir': './results/model_refine_he', # changed preprocessing according to ME version , lr schedule
