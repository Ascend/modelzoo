...
--per_batch_size=256 --data_dir=/path/to/dataset/train/ --is_distribute=1 --lr_scheduler=cosine_annealing \
--label_smooth=1 --T_max=90 --max_epoch=90 --backbone=resnet50 --lr=0.8 --warmup_epochs=5 --ckpt_interval=500